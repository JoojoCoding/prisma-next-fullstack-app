    ...
    <div className="max-w-5xl w-full mx-auto space-y-8">
        <div className="flex gap-4 items-center">
            <div className="aspect-video flex-shrink-0 w-1/3 relative">
                <img src={product.imagePath} alt={product.name} className="object-cover w-[50%] h-auto border" />
            </div>
            <div>
    ...
    return (
        <form onSubmit={handleSubmit}>
            <Card>
                ...
                <CardContent>
                    <PaymentElement />
                    <LinkAuthenticationElement className="mt-4" onChange={e => setEmail(e.value.email)}/>
                </CardContent>
                <CardFooter>
                    <Button 
                    className="w-full" 
